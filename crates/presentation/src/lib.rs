...
#[openapi(
    ...
    paths(
        ...
        routes::workspace::member_devices::list_member_devices,
    ...
    components(
        schemas(
            ...
            routes::workspace::member_devices::MemberDeviceResponse,
            routes::workspace::member_devices::ListMemberDevicesResponse,
