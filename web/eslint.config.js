  ...
  ...tseslint.configs.recommended,
  {
    ...
    settings: {
      ...
      "boundaries/elements": [
        ...
        // app layer: __root.tsx is the TanStack Router root layout
        { type: "app", pattern: "src/routes/__root.tsx", mode: "full" },
        // app layer: root-level files (router.tsx, styles.css, etc.)
      ...
      "boundaries/element-types": [
        "error",
        {
          ...
          rules: [
            ...
            // pages: all lower layers + pages (TanStack Router layout routes
            // use relative imports to their co-located -components/-hooks dirs,
            // which the plugin sees as sibling page elements)
