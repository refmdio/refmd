 ...
 *
 * Single source of truth for serializing and parsing RefMD recovery key files.
 * Used by registration (download) and recovery (file upload).
 */
...
export function parseRecoveryKeyFile(content: string): RecoveryKeyParseSuccess | RecoveryKeyParseError {
