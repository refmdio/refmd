...
import { Info, Shield, Users, User } from 'lucide-react'
      ...
      <DialogContent className="sm:max-w-5xl p-0 gap-0 h-[80vh]">
        <div className="flex h-full min-h-0">
          ...
          <div className="w-48 border-r border-border/60 py-4 shrink-0 overflow-y-auto">
            ...
            <nav role="tablist" aria-label="Settings" className="space-y-1 px-2">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
                  role="tab"
          ...
          <div className="flex-1 min-h-0 overflow-y-auto">
            ...
            {activeTab === 'workspace' && <WorkspaceSection onClose={() => onOpenChange(false)} />}
