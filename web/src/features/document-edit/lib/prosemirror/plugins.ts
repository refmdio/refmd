 ...
 *
 * Assembles the base plugin set for the WYSIWYG editor
 * (excluding Yjs collab plugins which are added separately).
 */
...
/**
 * Build plugins for collab mode (excludes history and undo/redo keymaps,
 * since yUndoPlugin handles undo/redo in collab mode).
 */
