...
use api::application::services::workspaces::WorkspacePermissionResolver;
...
use api::infrastructure::git::workspace::GitWorkspaceService;
...
pub struct GitStack {
    ...
    pub repo: Arc<dyn api::application::ports::git_repository::GitRepository>,
...
pub async fn build_git_stack(
    ...
    realtime_engine: Arc<dyn api::application::ports::realtime_port::RealtimeEngine>,
    document_repo: Arc<dyn api::application::ports::document_repository::DocumentRepository>,
    files_repo: Arc<dyn api::application::ports::files_repository::FilesRepository>,
