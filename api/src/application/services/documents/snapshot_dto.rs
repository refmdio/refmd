use crate::application::dto::documents::{SnapshotDiffDto, SnapshotDiffSideDto, SnapshotSummaryDto};
use crate::application::use_cases::documents::snapshot_diff::{SnapshotDiffResult, SnapshotDiffSide};
