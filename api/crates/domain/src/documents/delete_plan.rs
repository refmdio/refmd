        ...
        let nodes = vec![
            ...
            DeleteNode {
                ...
                meta: DocMeta {
                    ...
                    desired_path: crate::documents::path::DesiredPath::new("doc1").unwrap(),
            ...
            DeleteNode {
                ...
                meta: DocMeta {
                    ...
                    desired_path: crate::documents::path::DesiredPath::new("folder").unwrap(),
            ...
            DeleteNode {
                ...
                meta: DocMeta {
                    ...
                    desired_path: crate::documents::path::DesiredPath::new("folder/leaf").unwrap(),
