...
mod subcontexts;
pub use subcontexts::{
    CoreContext, DocumentsContext, GitContext, IdentityContext, PluginsContext, WorkspacesContext,
    WsContext,
};
...
impl AppContext {
    ...
    pub fn plugin_event_subscriber(&self) -> Arc<dyn PluginEventSubscriber> {
        self.services.plugins.plugin_event_subscriber.clone()
    }
    ...
    pub fn realtime_engine(&self) -> Arc<dyn RealtimeEngine> {
        self.services.documents.realtime_engine.clone()
    }
