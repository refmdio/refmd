...
use crate::linkgraph;
use crate::ports::document_snapshot_archive_repository::{
    DocumentSnapshotArchiveRepository, SnapshotArchiveInsert, SnapshotArchiveRecord,
};
use crate::ports::linkgraph_repository::LinkGraphRepository;
use crate::ports::realtime_hydration_port::DocStateReader;
use crate::ports::realtime_persistence_port::DocPersistencePort;
use crate::ports::storage_projection_queue::{
    StorageProjectionJobKind, StorageProjectionQueue,
};
use crate::ports::tagging_repository::TaggingRepository;
...
fn repo_path_from_record(
    record: &crate::ports::realtime_hydration_port::DocumentRecord,
) -> Option<String> {
