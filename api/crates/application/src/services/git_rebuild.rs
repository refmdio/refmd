...
use crate::contracts::git::GitSyncRequestDto;
use crate::ports::git_rebuild_job_queue::{GitRebuildJob, GitRebuildJobQueue};
...
use crate::services::workspaces::WorkspacePermissionResolver;
use crate::services::workspaces::permission_snapshot::permission_set_from_snapshot;
use crate::use_cases::git::helpers::needs_force_retry;
...
mod tests {
    ...
    impl GitWorkspacePort for RecordingWorkspace {
        ...
        async fn status(
            &self,
            _workspace_id: Uuid,
        ) -> anyhow::Result<crate::contracts::git::GitWorkspaceStatus> {
            Ok(crate::contracts::git::GitWorkspaceStatus {
        ...
        async fn list_changes(
            &self,
            _workspace_id: Uuid,
        ) -> anyhow::Result<Vec<crate::contracts::git::GitChangeItem>> {
            unimplemented!()
        }
        ...
        async fn working_diff(
            &self,
            _workspace_id: Uuid,
        ) -> anyhow::Result<Vec<crate::contracts::diff::TextDiffResult>> {
            unimplemented!()
        }
        ...
        async fn history(
            &self,
            _workspace_id: Uuid,
        ) -> anyhow::Result<Vec<crate::contracts::git::GitCommitInfo>> {
            unimplemented!()
        }
        ...
        async fn sync(
            ...
            _cfg: Option<&crate::ports::git_repository::UserGitCfg>,
        ) -> anyhow::Result<crate::contracts::git::GitSyncOutcome> {
            self.outcomes.lock().unwrap().push(req.clone());
            if let Some(err) = self.failures.lock().unwrap().pop_front() {
                Err(err)
            } else {
                Ok(crate::contracts::git::GitSyncOutcome {
                    files_changed: 1,
        ...
        async fn import_repository(
            ...
            _workspace_id: Uuid,
            _actor_id: Uuid,
            _cfg: &crate::ports::git_repository::UserGitCfg,
        ) -> anyhow::Result<crate::contracts::git::GitImportOutcome> {
            Ok(crate::contracts::git::GitImportOutcome {
                files_changed: 0,
                commit_hash: None,
                docs_created: 0,
        ...
        async fn pull(
            ...
            _workspace_id: Uuid,
            _actor_id: Uuid,
            _req: &crate::contracts::git::GitPullRequestDto,
            _cfg: &crate::ports::git_repository::UserGitCfg,
        ) -> anyhow::Result<crate::contracts::git::GitPullResultDto> {
            Ok(crate::contracts::git::GitPullResultDto {
                success: true,
        ...
        async fn check_remote(
            ...
            _workspace_id: Uuid,
            _cfg: &crate::ports::git_repository::UserGitCfg,
        ) -> anyhow::Result<crate::contracts::git::GitRemoteCheckDto> {
            Ok(crate::contracts::git::GitRemoteCheckDto {
                ok: true,
                message: "ok".into(),
                reason: None,
            })
    ...
    impl GitRepository for RecordingGitRepo {
        ...
        async fn load_user_git_cfg(
            &self,
            _user_id: Uuid,
        ) -> anyhow::Result<Option<crate::ports::git_repository::UserGitCfg>> {
            Ok(None)
        }
