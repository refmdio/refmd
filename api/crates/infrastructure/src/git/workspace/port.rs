...
impl GitWorkspacePort for GitWorkspaceService {
    ...
    async fn sync(
        ...
        self.sync_inner(workspace_id, req, cfg).await
    }
    ...
    async fn import_repository(
        ...
        self.import_repository_inner(workspace_id, actor_id, cfg).await
    }
    ...
    async fn pull(
        ...
        self.pull_with_recovery(workspace_id, actor_id, req, cfg).await
    }
    ...
    async fn remote_head(
        ...
        self.remote_head_inner(workspace_id, cfg).await
    }
    ...
    async fn check_remote(
        ...
        self.check_remote_inner(workspace_id, cfg).await
    }
