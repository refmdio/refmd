...
use application::ports::storage_ingest_queue::{StorageIngestEvent, StorageIngestQueue};
use application::services::metrics::MetricsRegistry;
use application::services::storage_ingest::StorageIngestHandler;
...
mod tests {
    use super::*;
    use application::ports::storage_ingest_queue::StorageIngestKind;
    use chrono::Utc;
    use std::sync::Mutex;
    use uuid::Uuid;
    ...
    impl StorageIngestQueue for MockQueue {
        ...
        async fn stats(
            &self,
        ) -> anyhow::Result<application::ports::storage_ingest_queue::StorageIngestQueueStats>
        {
            unimplemented!()
        }
    }
