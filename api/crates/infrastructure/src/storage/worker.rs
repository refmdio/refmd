...
use application::ports::storage_projection_queue::{
...
use application::services::storage_projection_cache::RecentProjectionCache;
use application::services::workspaces::WorkspacePermissionResolver;
use application::services::workspaces::permission_snapshot::permission_set_from_snapshot;
use domain::workspaces::permissions::{
    PERM_DOC_DELETE, PERM_FILE_DELETE, PERM_FOLDER_DELETE, PermissionSet,
};
use crate::storage::suppress_git_dirty;
...
mod tests {
    ...
    use application::ports::storage_port::StoredAttachment;
