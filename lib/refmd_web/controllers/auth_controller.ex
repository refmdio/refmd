      ...
      with {:ok, user} <- Users.create_user_with_struct(user_struct, user_attrs),
           ...
           {:ok, _identity_key} <-
             Encryption.create_user_encrypted_identity_key(%{
               user_id: user.id,
               encrypted_ecdh_private: decode_optional_binary(params["encrypted_ecdh_private"]),
               encrypted_ecdh_private_nonce:
                 decode_optional_binary(params["encrypted_ecdh_private_nonce"]),
               encrypted_signing_private:
                 decode_optional_binary(params["encrypted_signing_private"]),
               encrypted_signing_private_nonce:
                 decode_optional_binary(params["encrypted_signing_private_nonce"])
             }),
           {:ok, workspace} <-
