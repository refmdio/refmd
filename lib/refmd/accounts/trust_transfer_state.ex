defmodule RefMD.Accounts.TrustTransferState do
  ...
  def changeset(record, attrs) do
    record
    |> cast(attrs, [:user_id, :target_device_id, :sender_device_id, :ciphertext, :nonce, :signature])
    |> validate_required([:user_id, :target_device_id, :sender_device_id, :ciphertext, :nonce, :signature])
