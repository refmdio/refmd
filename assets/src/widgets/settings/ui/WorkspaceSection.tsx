...
import { WorkspaceSectionContent } from "./workspace-section/WorkspaceSectionContent";
import { WorkspaceSectionDialogs } from "./workspace-section/WorkspaceSectionDialogs";
