        ...
        <div class="space-y-4">
            ...
            <SettingSelect
              ...
              onChange={(v) =>
                updateSettings.mutate({
                  editor_default_mode: v as "markdown" | "wysiwyg" | "split",
                })
              }
          ...
          >
            <SettingSelect
              ...
              onChange={(v) =>
                updateSettings.mutate({ editor_layout_mode: v as "tiling" | "horizontal" })
              }
              disabled={updateSettings.isPending}
            />
          </SettingRow>
...
function SettingSelect(props: {
  ...
  return (
    <Select
      ...
      itemComponent={(ip: { item: { rawValue: string } }) => (
        <SelectItem item={ip.item}>{findLabel(props.options, ip.item.rawValue)}</SelectItem>
      )}
