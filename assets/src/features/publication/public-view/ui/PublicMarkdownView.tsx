...
import "./public-markdown-view.css";
...
function collectHeadings(children: Root["children"], result: PublicMarkdownHeading[] = []) {
...
export function PublicMarkdownView(props: { root: Root }) {
  return <div class="public-markdown-view">{renderBlockChildren(props.root.children)}</div>;
}
