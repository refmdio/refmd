...
import type { WorkspaceMemberManagementModel } from "../model/useWorkspaceMemberManagement";
...
type AssignableRoleSelectState = {
  selectedOption: () => AssignableRole | null;
};
type AssignableRoleItemProps = {
  item: { rawValue: AssignableRole };
};

function RoleNameValue() {
  return (
    <SelectValue>
      {(selectState: AssignableRoleSelectState) => {
          ...
          <Show when={props.assignableRoles.length > 0}>
            <Field>
              ...
              <Select
                ...
                itemComponent={(itemProps: AssignableRoleItemProps) => (
