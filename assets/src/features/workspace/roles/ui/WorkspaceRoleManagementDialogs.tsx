...
import type { WorkspaceRoleManagementModel } from "../model/useWorkspaceRoleManagement";
...
type BaseRoleItemProps = { item: { rawValue: BaseRoleOption } };
type BaseRoleSelectState = {
          ...
          <div class="space-y-4">
            ...
            <Field>
              ...
              <Select
                ...
                itemComponent={(itemProps: BaseRoleItemProps) => (
              ...
              >
                <SelectTrigger>
                  <SelectValue>
                    {(selectState: BaseRoleSelectState) => {
