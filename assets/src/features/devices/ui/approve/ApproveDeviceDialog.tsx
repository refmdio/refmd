...
export function ApproveDeviceDialog(props: Props) {
  ...
  const identityHybridSigningPublicKeyMaterial = () => {
    ...
    return auth?.identityHybridSigningPublicKeyMaterial ?? null;
  };
  ...
  return (
    ...
    >
      <DialogContent>
        ...
        <Show when={tofuChecked() && !tofuBlocked() && identityHybridSigningPublicKeyMaterial()}>
          <SafetyNumber
            deviceId={props.device.id}
            identityHybridSigningPublicKeyMaterial={identityHybridSigningPublicKeyMaterial()!}
            deviceHybridSigningPublicKeyMaterial={
              decodedDeviceKeys().deviceHybridSigningPublicKeyMaterial
            }
            deviceHybridEncryptionPublicKeyMaterial={
              decodedDeviceKeys().deviceHybridEncryptionPublicKeyMaterial
            }
