...
export class CryptoWorkerClient {
  ...
  declare generateIdentitySuccessor: KeyWorkerClientMethods["generateIdentitySuccessor"];
  declare importIdentitySuccessor: KeyWorkerClientMethods["importIdentitySuccessor"];
  declare restoreActivatedIdentitySuccessor: KeyWorkerClientMethods["restoreActivatedIdentitySuccessor"];
  declare beginIdentitySuccessorFinalization: KeyWorkerClientMethods["beginIdentitySuccessorFinalization"];
  declare activateIdentitySuccessor: KeyWorkerClientMethods["activateIdentitySuccessor"];
  declare discardIdentitySuccessor: KeyWorkerClientMethods["discardIdentitySuccessor"];
  declare setIdentityRotationDeadline: KeyWorkerClientMethods["setIdentityRotationDeadline"];
  declare trustIdentityRotationCheckpoint: KeyWorkerClientMethods["trustIdentityRotationCheckpoint"];
  ...
  declare wrapIdentitySuccessorForServer: KeyWorkerClientMethods["wrapIdentitySuccessorForServer"];
  declare persistCurrentKeysWithDsk: KeyWorkerClientMethods["persistCurrentKeysWithDsk"];
  declare persistGuestPendingKeysWithDsk: KeyWorkerClientMethods["persistGuestPendingKeysWithDsk"];
  declare restoreGuestPendingKeysWithDsk: KeyWorkerClientMethods["restoreGuestPendingKeysWithDsk"];
  declare deleteGuestPendingKeysWithDsk: KeyWorkerClientMethods["deleteGuestPendingKeysWithDsk"];
  ...
  declare openRecipientBoundInvitationDeviceKekWrap: KekWorkerClientMethods["openRecipientBoundInvitationDeviceKekWrap"];
  ...
  declare openSignedPqGuestInvitationShareKeyWrap: KekWorkerClientMethods["openSignedPqGuestInvitationShareKeyWrap"];
  declare restoreGuestInvitationShareKey: KekWorkerClientMethods["restoreGuestInvitationShareKey"];
  declare commitGuestInvitationShareKey: KekWorkerClientMethods["commitGuestInvitationShareKey"];
  declare generateInitialAkeResponderPrekey: KekWorkerClientMethods["generateInitialAkeResponderPrekey"];
  declare beginInitialAkeUmkDelivery: KekWorkerClientMethods["beginInitialAkeUmkDelivery"];
  declare beginInitialAkeKekDelivery: KekWorkerClientMethods["beginInitialAkeKekDelivery"];
  declare beginInitialAkeDeviceStateTransferDelivery: KekWorkerClientMethods["beginInitialAkeDeviceStateTransferDelivery"];
  declare respondToInitialAkeOffer: KekWorkerClientMethods["respondToInitialAkeOffer"];
  declare finalizeInitialAkeDelivery: KekWorkerClientMethods["finalizeInitialAkeDelivery"];
  ...
  declare signIdentitySuccessorKeyDirectoryCheckpoint: SignWorkerClientMethods["signIdentitySuccessorKeyDirectoryCheckpoint"];
  ...
  declare signIdentitySuccessorKeyDirectoryEvent: SignWorkerClientMethods["signIdentitySuccessorKeyDirectoryEvent"];
