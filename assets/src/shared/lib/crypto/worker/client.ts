import type { DekWorkerClientMethods } from "./client-dek";
import { dekWorkerClientMethods } from "./client-dek";
import type { KekWorkerClientMethods } from "./client-kek";
import { kekWorkerClientMethods } from "./client-kek";
import type { KeyWorkerClientMethods } from "./client-keys";
import { keyWorkerClientMethods } from "./client-keys";
import type { LifecycleWorkerClientMethods } from "./client-lifecycle";
import { lifecycleWorkerClientMethods } from "./client-lifecycle";
import type { SignWorkerClientMethods } from "./client-sign";
import { signWorkerClientMethods } from "./client-sign";
import type { TofuWorkerClientMethods } from "./client-tofu";
import { tofuWorkerClientMethods } from "./client-tofu";
