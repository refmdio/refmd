...
export const documentRequestHandlers = {
  ...
  "encrypt-plugin-storage": (state, payload) => handleEncryptPluginStorage(state, payload),
  "decrypt-plugin-storage": (state, payload) =>
    withCryptoOperationError("decryption_failed", () => handleDecryptPluginStorage(state, payload)),
