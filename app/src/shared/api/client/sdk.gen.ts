 ...
 * @param data.id Document ID
 * @param data.token Share token (optional)
 * @returns DocumentCommentsResponse
 * @throws ApiError
 */
export const listDocumentComments = (data: ListDocumentCommentsData): CancelablePromise<ListDocumentCommentsResponse> => {
    return __request(OpenAPI, {
        method: 'GET',
        url: '/api/documents/{id}/comments',
        path: {
            id: data.id
        },
        query: {
 ...
 * @param data.requestBody
 * @param data.token Share token (optional)
 * @returns DocumentCommentThread
 * @throws ApiError
 */
export const createDocumentCommentThread = (data: CreateDocumentCommentThreadData): CancelablePromise<CreateDocumentCommentThreadResponse> => {
    return __request(OpenAPI, {
        method: 'POST',
        url: '/api/documents/{id}/comments',
        path: {
 ...
 * @throws ApiError
 */
export const updateDocumentCommentThread = (data: UpdateDocumentCommentThreadData): CancelablePromise<UpdateDocumentCommentThreadResponse> => {
    return __request(OpenAPI, {
        method: 'PATCH',
        url: '/api/documents/{id}/comments/{thread_id}',
        path: {
            id: data.id,
 ...
 * @throws ApiError
 */
export const createDocumentCommentReply = (data: CreateDocumentCommentReplyData): CancelablePromise<CreateDocumentCommentReplyResponse> => {
    return __request(OpenAPI, {
        method: 'POST',
        url: '/api/documents/{id}/comments/{thread_id}/replies',
        path: {
            id: data.id,
            thread_id: data.threadId
        },
